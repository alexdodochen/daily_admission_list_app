...
- [3-card app integration state](project_3card_app_state.md) — Phase 19 (2026-05-21): 6-issue field-bug batch #2-#7 (sheet/read N-V truncated by main_end, integrate appends missing, lottery H→R, name "?" strip, 備註住服 editable, bug-report buttons, cathlab verify honours 不排, main↔sub chart_no reconcile). d7b3450, 409 tests.
