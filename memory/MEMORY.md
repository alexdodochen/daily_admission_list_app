...
- [3-card app integration state](project_3card_app_state.md) — daily_admission_list_app shape (public, .exe distribution); Cards 1/2/3 module map; cross-cutting features (viewer, bug-report, field mirror)
